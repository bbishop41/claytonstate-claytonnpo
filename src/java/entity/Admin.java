...
@NamedQueries({
    ...
    @NamedQuery(name = "Admin.findAdminName", query = "SELECT a FROM Admin a WHERE a.pass = :pass AND a.email = :email")})
public class Admin implements Serializable {
    ...
    public Admin(Integer adminID, String username, String pass, String email) {
        this.adminID = adminID;
